...
@section('content')
    ...
    <x-card title="Danh sách sinh viên CSDL (Eloquent)">
        <form method="get" action="{{ url('/students/db') }}" style="margin-
                                bottom:12px">
...
@if(session('success'))
    <div
        style="background-color: #DCFCE7; color: #166534; padding: 10px; margin-bottom: 15px; border-radius: 5px; border: 1px solid #166534;">
        {{ session('success') }}
    </div>
@endif